...
export function Topbar({ onCmdK, onAiToggle }: TopbarProps) {
  return (
    <header className="h-16 flex items-center justify-between px-6 border-b border-border bg-white/80 backdrop-blur-sm shrink-0 sticky top-0 z-10">
      <button
        onClick={onCmdK}
      ...
      >
        ...
        <span className="flex-1 text-left">Ara veya komut gir...</span>
