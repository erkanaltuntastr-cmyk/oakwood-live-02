    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm oak-card-elevated px-7 py-9 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2 mb-8">
          Profil oluşturuldu. Şimdi bir çocuk eklemek ister misin?
        </p>

        <div className="space-y-3">
          <button
            onClick={() => navigate('/register/child')}
            className="w-full h-12 oak-btn-primary flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full h-12 oak-btn-ghost flex items-center justify-center gap-2"
          >
            Dashboard'a Geç
